    ...
    <div class="plan-card-panel" aria-hidden="false">
      <div class="plan-card-panel-inner">
        <div class="plan-grid">
          ...
          <button type="button" class="small plan-expected-return-suggest plan-expected-return-suggest-row">提案値に戻す</button>
          <label class="plan-withdrawal-day-field">引き落とし日<input class="plan-withdrawal-day" type="number" min="1" max="31" step="1" value="${normalizedPlan.withdrawalDay ?? 1}" /></label>
          <label class="plan-withdraw-month-field">一括解約年月<input class="plan-withdraw-month" type="month" value="${normalizedPlan.withdrawMonth || ""}" /></label>
